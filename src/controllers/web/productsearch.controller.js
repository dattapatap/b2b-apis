...
export const searchProducts = asyncHandler(async (req, res) => {
  const {category, subcategory, city, industry, page = 1, limit = 10, sortBy } = req.query;
  ...
  // category, subcategory, industry are names (strings) and need to be converted to ObjectId
